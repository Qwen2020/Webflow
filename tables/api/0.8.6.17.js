...
formatNumber(num) {
    ...
    if (formattedNum >= 1e12) {
        formattedNum = (formattedNum / 1e12).toFixed(2);
        suffix = 'T';
    } else if (formattedNum >= 1e9) {
        formattedNum = (formattedNum / 1e9).toFixed(2);
        suffix = 'B';
    } else if (formattedNum >= 1e6) {
        formattedNum = (formattedNum / 1e6).toFixed(2);
        suffix = 'M';
    } else {
        formattedNum = formattedNum.toFixed(2); // Format to two decimal places
    }
